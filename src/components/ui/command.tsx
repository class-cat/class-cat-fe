...
>(({ className, ...props }, ref) => (
  <div
    className="flex items-center  border-b-2 border-primary  px-3"
    cmdk-input-wrapper=""
  >
    ...
    <CommandPrimitive.Input
      ref={ref}
      className={cn(
        "placeholder:text-muted-foreground flex h-11 w-full rounded-md bg-popover py-3 text-sm outline-none disabled:cursor-not-allowed disabled:opacity-50",
        className
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.List
    ref={ref}
    className={cn(
      "sidebarSmall max-h-[300px] overflow-y-auto overflow-x-hidden",
      className
    )}
    {...props}
  />
