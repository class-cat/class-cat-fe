          ...
          {(isGlobalLoading) => (
            <>
              <SignUp.Step name="start">
                <Card className="border-secondary border-2 bg-[#FFFFFF] shadow-none">
                  <CardHeader>
                    <CardTitle className="text-primary mx-auto text-lg">
                      Zarejestruj się
                    </CardTitle>
                  ...
                  <CardContent className="grid gap-y-4">
                    ...
                    <p className="text-muted-foreground before:bg-secondary after:bg-secondary flex items-center gap-x-3 text-sm before:h-px before:flex-1 after:h-px after:flex-1">
                      lub
                    </p>
                    <Clerk.Field name="emailAddress" className="space-y-2">
                      ...
                      <Clerk.Input type="email" required asChild>
                        <Input className="border-secondary rounded-xl border-[0.1px] bg-slate-100" />
                      </Clerk.Input>
